import { Title, Blockquote, Stack, TextInput, PasswordInput, Button, Checkbox } from '@mantine/core';
            ...
            <form className={classes.form} onSubmit={form.onSubmit(() => handleAuthentication())}>
                ...
                <Stack gap={0}>
                    ...
                    <PasswordInput
                        ...
                        radius="md"
                        leftSection={<IconLock size={18} />}
                        error={form.errors.password !== form.errors.passwordConfirmation && 'Password does not match'}
